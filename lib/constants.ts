...
export const TOAST = {
  ...
  deadlineSoon: 'Ó o relógio! Falta menos de 1h pro jogo.',
  ...
  // Perfil
  profileUpdated: 'Atualizado!',
  // Palpite
  betLocked: 'Deadline passou, mano. Esse jogo tá travado.',
  // Admin
  adminMatchUpdated: 'Placar atualizado. Palpites recalculados. 🎯',
  adminMatchCancelled: 'Jogo cancelado. Palpites zerados.',
  adminTierUpdated: 'Tier atualizado. Histórico registrado.',
  adminEmailAdded: 'E-mail adicionado à lista.',
  adminEmailRemoved: 'E-mail removido da lista.',
  adminApiToggled: 'Status da API atualizado.',
  adminSyncDone: 'Sincronização concluída.',
  adminRecalcDone: 'Palpites recalculados com sucesso.',
  adminBannerSet: 'Banner publicado para todos.',
  adminBannerCleared: 'Banner removido.',
  adminAvatarRemoved: 'Avatar removido.',
